...
//array ou objecto: manualmente informar o tipo da variavel
interface Item{
    id:number,
    title:string,
    image_url:string
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select name="uf" id="uf" value={ufSelected} onChange={handleUFSelected} >
                        ...
                        <div className="field">
                            ...
                            <select name="city" onChange={handleCitySelected} id="city">
